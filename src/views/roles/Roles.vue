<template>
  <div class="roles_view">
      ...
      <el-table :data="rolesList" stripe style="width: 100%">
        ...
        <el-table-column type="expand">
          <template #default="scope">
            <el-row v-for="(item1, index1) in scope.row.children" :key="item1.id" :class="['row_bottom', index1 === 0 ? 'row_top' : '']">
              <!--              一级权限-->
              <el-col :span="5">
    ...
    <!--   添加用户对话框 -->
    <el-dialog title="添加用户" :visible.sync="addRolesBox" width="50%" @close="resetForm">
    ...
    <!--    编辑角色信息-->
    <el-dialog title="编辑角色信息" :visible.sync="editRolesBox" width="50%" @close="resetForm">
    ...
    <!--    分配权限对话框-->
    <el-dialog title="分配权限" :visible.sync="setRightDialog" width="50%" @close="resetRightDialog">
      <!--      树形结构-->
      <el-tree :data="rightsList" :props="treeProps" node-key="id" :default-checked-keys="defaultKey" ref="treeRef" show-checkbox default-expand-all></el-tree>
      <span slot="footer">
